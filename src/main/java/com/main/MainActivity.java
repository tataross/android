...
public class MainActivity extends android.app.Activity   
{
    ...
    public void onCreate(final android.os.Bundle savedInstanceState)   
    {
        ...
        text.setText(new java.io.BufferedReader(new java.io.InputStreamReader(super.getAsserts().open("file.txt"), java.nio.charset.StandardCharset.UTF_8))).lines().collect(Collectors.joining("\n")));
        body.addView(text);  
